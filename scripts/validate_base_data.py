...
REQUIRED_SCRIPT_MARKERS = {
    ...
    'scripts/comparative-results.mjs': [
        'buildComparativeResultsReport',
        'One row per settled match',
        'predicted_advancing_team',
        'actual_advancing_team',
        'predicted_advancement_confidence',
        'advancement_correct',
        'advancement_accuracy',
        'penalty-decided tied score remains a draw for WDL scoring',
        'validateNoMarketFields',
    ],
    'scripts/validate-calibration.mjs': [
        'REQUIRED_LEDGER_FIELDS',
